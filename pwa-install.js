(function() {
  ...
  banner.innerHTML = `
    <div style="display:flex; align-items:center; gap:12px; background:var(--aspal-2, #1E2124); padding:12px 16px; border-radius:12px; border:1px solid rgba(255,255,255,0.1); box-shadow:0 10px 30px rgba(0,0,0,0.5);">
      ...
      <div style="flex:1;">
        ...
        <div style="font-size:12px; color:var(--chrome, #A9A49B); line-height:1.3; margin-top:4px;">Install aplikasi untuk akses lebih cepat & hemat kuota.</div>
      </div>
